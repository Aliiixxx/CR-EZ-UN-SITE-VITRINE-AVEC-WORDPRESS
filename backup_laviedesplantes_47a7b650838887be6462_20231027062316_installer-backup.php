...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'backup_laviedesplantes_47a7b650838887be6462_20231027062316_archive.zip';
        const ARCHIVE_SIZE       = '70830551';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '47a7b65-27062316';
        const SECONDARY_PACKAGE_HASH = '8152c7d-27062316';
        const VERSION            = '1.5.6';
